...
export default function AdminLayout({
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <aside
        className={`
          fixed top-0 left-0 z-40 h-screen w-56 bg-white border-r border-gray-200
          ...
          <div className="px-4 py-5 border-b border-gray-200">
            <Link href="/admin" className="flex items-center gap-2.5">
              <div className="w-7 h-7 bg-slate-900 rounded flex items-center justify-center">
                <span className="text-white font-semibold text-xs">CU</span>
              </div>
              <div>
                <h1 className="text-sm font-semibold text-slate-900 tracking-tight">Admin Panel</h1>
                <p className="text-xs text-slate-500 font-normal">Cool URLs</p>
              </div>
            </Link>
          </div>
                ...
                return (
                  <li key={item.href}>
                    <Link
                      href={item.href}
                      className={`
                        flex items-center gap-2.5 px-3 py-1.5 rounded-md transition-all duration-150
                        ${
                          isActive
          ...
          <div className="px-3 py-3 border-t border-gray-200">
            <div className="flex items-center gap-2.5 mb-2 px-3 py-2">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-xs text-slate-500 font-normal">Administrator</p>
              </div>
            </div>
            <Button
              ...
              variant="outline"
              size="sm"
              className="w-full justify-start gap-2 text-xs h-8 border-slate-200 hover:bg-slate-50"
            >
